...
//  ChefDelivery
//
//  Created by Juan Carlos on 04/01/24.
//
...
let ordersMock: [OrderType] = [
    ...
    OrderType(id: 5, name: "Mercados", image: "mercado"),
    OrderType(id: 6, name: "Pets", image: "petshop"),
    OrderType(id: 7, name: "Bebeidas", image: "bebidas"),
]
